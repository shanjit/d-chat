...
queue<message_information> ack_message_queue;

mutex ack_message_queue_mtx;
...
{	
	...
	{	
		...
		*ch = (char *) send_packet;
		...
		ack_message_queue_mtx.lock();
		ack_message_queue.push(send_message);
		ack_message_queue_mtx.unlock();
